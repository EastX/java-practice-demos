...
public class LocalCacheUtil {
    ...
    /** 最大缓存数量 */
    private static final int MAX_NUM = CacheProperties.getLocalMaxSize();
    /** 最大过期时长 */
    private static final long MAX_TTL = TimeUnit.MINUTES.toMillis(CacheProperties.getLocalMaxTtl());
    ...
    static class CacheExpiry implements Expiry<String, Object> {
        ...
        public long expireAfterCreate(@NonNull String key, @NonNull Object value, long currentTime) {
            logger.debug("[CacheExpiry]expireAfterCreate, key={}, value={}, time={}",
        ...
        public long expireAfterUpdate(@NonNull String key, @NonNull Object value,
            ...
            logger.debug("[CacheExpiry]expireAfterUpdate, key={}, value={}, time={}, duration={}",
        ...
        public long expireAfterRead(@NonNull String key, @NonNull Object value, long currentTime,
            ...
            logger.debug("[CacheExpiry]expireAfterRead, key={}, value={}, time={}, duration={}",
                    key, value, currentTime, currentDuration);
            return currentDuration;
        }
